// Journal alimentaire — fonctions pures du module Nutrition.
//
// Extrait de src/nutrition/foodStore.js (apps/perso) le 05/08/2026, chantier RawCare
// Phase 0. Seule la partie pure déménage ici : le hook `useFoodLog()` (React, dépend de
// `store.js` pour la persistance localStorage) reste côté app, qui ré-exporte tout ce
// fichier et ajoute le hook par-dessus — voir apps/perso/src/nutrition/foodStore.js.
//
