  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      ...
      {/* `minWidth: 0` sur les deux : par défaut un enfant flex refuse de rétrécir sous la
          taille de son contenu (min-width: auto), ce qui pouvait couper les chiffres d'une
          valeur à 3 chiffres (ex. 220) dans une grille 2 colonnes étroite — trouvé le
          06/08/2026 côté apps/public (copie verbatim de ce fichier), corrigé ici aussi pour
          ne pas laisser les deux diverger. */}
