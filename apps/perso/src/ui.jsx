...
/* ---------- utilitaires dont les primitives dépendent ---------- */
// Formate un objet Date en "YYYY-MM-DD" à partir de ses champs LOCAUX (année/mois/jour
// tels qu'affichés sur l'appareil) — jamais `.toISOString()`, qui bascule en UTC et décale
// la date de l'écart au fuseau local (+2h en France l'été) : entre minuit et 2h du matin,
// ça faisait passer "aujourd'hui" pour "hier" partout dans l'app, y compris le découpage
// des pas synchronisés depuis Health Connect. Corrigé le 03/08/2026, trouvé en creusant un
// écart entre le nombre de pas de Samsung Health et celui affiché par PROTOCOLE.
export const localDateKey = (d) =>
  `${d.getFullYear()}-${String(d.getMonth() + 1).padStart(2, "0")}-${String(d.getDate()).padStart(2, "0")}`;
export const today = () => localDateKey(new Date());
// Décale une clé "YYYY-MM-DD" de `days` jours, en arithmétique LOCALE pure (construction
// via `new Date(y, m, d)`, jamais un aller-retour par un instant UTC qui redécalerait la
