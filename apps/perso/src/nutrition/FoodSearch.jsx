...
function FreeEntry({ onAdd, onBack, backLabel = "Saisie libre" }) {
  ...
  // Calories seules (05/09/2026, demande explicite de Yoann) : utile pour un article dont
  // seule l'étiquette calorique est lisible (ex. distributeur, emballage abîmé). N'a de sens
  // QUE si aucune macro n'est renseignée à côté — sinon deux sources de calories (saisie
  // manuelle vs 4/4/9+fibres calculé) coexisteraient sans qu'on sache laquelle est la vraie.
